...
from lib.models.hotmoe.base_backbone import BaseBackbone
...
def vit_base_patch16_224(pretrained=False, **kwargs):
    ...
    """
    model_kwargs = dict(
        patch_size=16, embed_dim=768, depth=12, num_heads=12, in_chans=3, **kwargs)
...
def vit_small_patch16_224(pretrained=False, **kwargs):
    ...
    """
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=8, num_heads=12, **kwargs)
