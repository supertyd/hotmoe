...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
    ...
    # settings.config_teacher = config_teacher   # for teacher model ditillation config
    # settings.script_teacher = script_teacher   # for teacher model distillation
...
def main():
    ...
    parser.add_argument('--script', type=str, default="hotmoe", help='Name of the train script.')
    parser.add_argument('--config', type=str, default="deep_all", help="Name of the config file.")
    ...
    parser.add_argument('--script_teacher', default="ostrack", type=str, help='teacher script name')
    parser.add_argument('--config_teacher', default="deep_all_teacher", type=str, help='teacher yaml configure file name')
