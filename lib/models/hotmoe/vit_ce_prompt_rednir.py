...
class VisionTransformerCE(VisionTransformer):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        if self.prompt_type in ['vipt_shaw', 'vipt_deep']:
            ...
            prompt_norms_rednir = []
            for i in range(block_nums):
                prompt_norms_rednir.append(norm_layer(embed_dim))
            self.prompt_rednir_norms = nn.Sequential(*prompt_norms_rednir)
...
def vit_base_patch16_224_ce_prompt_rednir(pretrained=False, **kwargs):
