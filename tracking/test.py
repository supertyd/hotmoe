...
def main():
    ...
    parser.add_argument('--tracker_name', default="hotmoe", type=str, help='Name of tracking method.')
    parser.add_argument('--tracker_param', default="deep_all", type=str, help='Name of config file.')
    parser.add_argument('--runid', type=int, default=None, help='The run id.')
    parser.add_argument('--dataset_name', type=str, default='whisper', help='Name of dataset (otb, nfs, uav, tpl, vot, tn, gott, gotv, lasot).')
